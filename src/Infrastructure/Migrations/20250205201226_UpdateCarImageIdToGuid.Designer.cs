...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250205201226_UpdateCarImageIdToGuid")]
    partial class UpdateCarImageIdToGuid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Cars.CarImage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_car_image");

                    b.HasIndex("CarId")
                        .HasDatabaseName("ix_car_image_car_id");

                    b.ToTable("car_image", "public");
                });
            ...
            modelBuilder.Entity("Domain.Cars.CarImage", b =>
                {
                    b.HasOne("Domain.Cars.Car", "Car")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_car_image_cars_car_id");
