...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260921195221_AddDealerSettingsLandingCustomization")]
    partial class AddDealerSettingsLandingCustomization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Appointments.Appointment", b =>
                {
                    ...
                    b.HasIndex("LeadId")
                        .HasDatabaseName("ix_appointments_lead_id");
            ...
            modelBuilder.Entity("Domain.Cars.BackfillAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("AffectedRowCount")
                        ...
                        .HasColumnName("affected_row_count");
                    ...
                    b.ToTable("backfill_audit", "public");
                });
            ...
            modelBuilder.Entity("Domain.DealerSettings.DealerSettings", b =>
                {
                    ...
                    b.Property<string>("CarouselSlidesJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("carousel_slides_json");
                    ...
                    b.Property<string>("ValuesText")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                        .HasColumnName("values_text");

                    b.Property<string>("VisionText")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                        .HasColumnName("vision_text");
            ...
            modelBuilder.Entity("Domain.Documents.Document", b =>
                {
                    ...
                    b.HasIndex("SaleId")
                        .HasDatabaseName("ix_documents_sale_id");
            ...
            modelBuilder.Entity("Domain.Leads.Lead", b =>
                {
                    ...
                    b.Property<Guid?>("InterestedVehicleId")
                        .HasColumnType("uuid")
                        .HasColumnName("interested_vehicle_id");
                    ...
                    b.HasIndex("ConvertedClientId")
                        .HasDatabaseName("ix_leads_converted_client_id");

                    b.HasIndex("InterestedVehicleId")
                        .HasDatabaseName("ix_leads_interested_vehicle_id");
            ...
            modelBuilder.Entity("Domain.Platform.PlatformAuditLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("DealerSettingsId")
                        .HasColumnType("uuid")
                        .HasColumnName("dealer_settings_id");
                    ...
                    b.HasIndex("OccurredAtUtc")
                        .IsDescending()
                        .HasDatabaseName("ix_platform_audit_logs_occurred_at_utc");

                    b.HasIndex("SourceEventKey")
                        .IsUnique()
                        .HasDatabaseName("ux_platform_audit_logs_source_event_key");

                    b.HasIndex("Action", "OccurredAtUtc")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_platform_audit_logs_action_occurred_at_utc");

                    b.HasIndex("DealerId", "OccurredAtUtc")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_platform_audit_logs_dealer_id_occurred_at_utc");
            ...
            modelBuilder.Entity("Domain.Quotes.Quote", b =>
                {
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("ix_quotes_is_deleted");

                    b.HasIndex("LeadId")
                        .HasDatabaseName("ix_quotes_lead_id");

                    b.HasIndex(new[] { "CarId" }, "ix_quotes_car_id")
                        .HasDatabaseName("ix_quotes_car_id");

                    b.HasIndex(new[] { "CarId" }, "ux_quotes_one_accepted_per_car")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Sales.Sale", b =>
                {
                    ...
                    b.Property<string>("FinancingEntity")
                        .HasMaxLength(120)
                    ...
                    b.Property<string>("TransferFormNumber")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("Domain.Appointments.Appointment", b =>
                {
                    ...
                    b.HasOne("Domain.Leads.Lead", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_appointments_leads_lead_id");
            ...
            modelBuilder.Entity("Domain.Clients.Client", b =>
                {
                    b.HasOne("Domain.Leads.Lead", null)
                        .WithMany()
                        .HasForeignKey("OriginLeadId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_clients_leads_origin_lead_id");
                });
            ...
            modelBuilder.Entity("Domain.Documents.Document", b =>
                {
                    ...
                    b.HasOne("Domain.Sales.Sale", null)
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_documents_sales_sale_id");
            ...
            modelBuilder.Entity("Domain.Leads.Lead", b =>
                {
                    b.HasOne("Domain.Clients.Client", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_leads_clients_converted_client_id");
            ...
            modelBuilder.Entity("Domain.Quotes.Quote", b =>
                {
                    ...
                    b.HasOne("Domain.Leads.Lead", "Lead")
                        .WithMany()
                        .HasForeignKey("LeadId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_quotes_leads_lead_id");
            ...
            modelBuilder.Entity("Domain.Sales.Sale", b =>
                {
                    ...
                    b.HasOne("Domain.Quotes.Quote", null)
                        .WithMany()
                        .HasForeignKey("QuoteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sales_quotes_quote_id");
