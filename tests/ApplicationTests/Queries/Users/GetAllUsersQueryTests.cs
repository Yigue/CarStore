...
public class GetAllUsersQueryTests
{
    ...
    public async Task Handle_DefaultQuery_ReturnsPaginatedUsers()
    {
        ...
        context.Users.Add(new User(dealerId, "alice@example.com", "Alice", "Johnson", "hash1"));
        context.Users.Add(new User(dealerId, "bob@example.com", "Bob", "Brown", "hash2"));
        context.Users.Add(new User(dealerId, "carol@example.com", "Carol", "Anderson", "hash3"));
    ...
    public async Task Handle_OrdersByLastNameFirstName()
    {
        ...
        context.Users.Add(new User(dealerId, "bob@example.com", "Bob", "Brown", "hash2"));
        context.Users.Add(new User(dealerId, "carol@example.com", "Carol", "Anderson", "hash3"));
        context.Users.Add(new User(dealerId, "dave@example.com", "Dave", "Williams", "hash4"));
        await context.SaveChangesAsync();
    ...
    public async Task Handle_ReturnsCorrectUserData()
    {
        ...
        var user = new User(dealerId, "test@example.com", "John", "Doe", "hash");
    ...
    public async Task Handle_TenantIsolation_ReturnsOnlyCurrentTenantUsers()
    {
        ...
        context.Users.Add(new User(dealerId1, "dealer1@example.com", "Dealer", "One", "hash1"));
        // Add users for dealer2
        context.Users.Add(new User(dealerId2, "dealer2@example.com", "Dealer", "Two", "hash2"));
        await context.SaveChangesAsync();
    ...
    public async Task Handle_ActiveUsersOnly_ReturnsOnlyActive()
    {
        ...
        context.Users.Add(new User(dealerId, "active@example.com", "Active", "User", "hash1"));
        var inactiveUser = new User(dealerId, "inactive@example.com", "Inactive", "User", "hash2");
    ...
    public async Task Handle_SearchFilter_FiltersByName()
    {
        ...
        context.Users.Add(new User(dealerId, "john@example.com", "John", "Doe", "hash1"));
        context.Users.Add(new User(dealerId, "jane@example.com", "Jane", "Smith", "hash2"));
        context.Users.Add(new User(dealerId, "bob@example.com", "Bob", "Brown", "hash3"));
        await context.SaveChangesAsync();
    ...
    public async Task Handle_RoleFilter_FiltersByRole()
    {
        ...
        context.Users.Add(new User(dealerId, "admin@example.com", "Admin", "User", "hash1", UserRole.Admin));
        context.Users.Add(new User(dealerId, "empleado@example.com", "Empleado", "User", "hash2", UserRole.Empleado));
        context.Users.Add(new User(dealerId, "cliente@example.com", "Cliente", "User", "hash3", UserRole.Cliente));
        await context.SaveChangesAsync();

        var handler = CreateHandler(context, mockTenantService.Object);
        var query = new GetAllUsersQuery() { Role = UserRole.Admin };

        var result = await handler.Handle(query, CancellationToken.None);

        result.IsSuccess.Should().BeTrue();
        result.Value.Data.Should().HaveCount(1);
        result.Value.Data.First().Role.Should().Be("Admin");
    }
}